...
from subscriber_manager import get_subscriber_manager, SubscriberManager
...
class BroadcastManager:
    ...
    async def _send_broadcast_to_user(
        ...
        message = (
            f"?? **{user_mention}, you have a new important message!**\n\n"
            f"**Message from channel:**\n{broadcast.message_text}\n\n"
            f"---\n"
            f"_This is an automated notification from the channel._"
        )
        ...
        # Send to the user's private chat with the bot
